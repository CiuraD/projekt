...
class UserController implements Controller {
   ...
   private initializeRoutes() {
       ...
       this.router.post(`${this.path}/resetPassword`, auth,  this.resetPassword);
   }
 ...
 private resetPassword = async (request: Request, response: Response, next: NextFunction) => {
    ...
    try {
        ...
        let password = await this.passwordService.hashPassword(this.passwordService.generateRandomPasswod());
        let userId = user._id;
        let date = {userId: userId, password: password};
        await this.passwordService.createOrUpdate(date);
